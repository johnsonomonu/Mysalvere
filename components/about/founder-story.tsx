...
export function FounderStory() {
  return (
    <section className="py-24 lg:py-32 bg-[var(--soft-white)] overflow-hidden" id="founder-story">
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-24 items-center">
          ...
          <div>
            ...
            <FadeInUp delay={0.2}>
              <h2 className="font-serif text-4xl font-medium tracking-tight text-[var(--charcoal)] sm:text-5xl leading-tight mb-10">
                From Clinical Practice to <span className="text-[var(--orange)]">Performance Systems.</span>
              </h2>
            </FadeInUp>

            <div className="space-y-6 text-lg text-[var(--charcoal)]/70 leading-relaxed font-light">
              <FadeInUp delay={0.3}>
                <p>
              ...
              <FadeInUp delay={0.5}>
                <div className="mt-12 p-10 bg-white rounded-[2.5rem] border border-[var(--orange)]/10 shadow-sm relative overflow-hidden group hover:shadow-xl transition-all duration-500">
                  <div className="absolute top-0 left-0 w-2 h-full bg-[var(--orange)]" />
                  <Quote className="h-10 w-10 text-[var(--orange)] opacity-10 absolute top-8 right-8" />
                  <p className="text-xl text-[var(--charcoal)] font-medium italic relative z-10 leading-relaxed">
